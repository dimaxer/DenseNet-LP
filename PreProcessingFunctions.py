...
import source
import DenseNetController, DenseNetGui
from source import *
...
def generate_node_combinations(num_of_nodes):
    print("Generate node combinations")
...
def convert_all_node_pairs_into_picture_data(feature_matrix, node_combination_list, dictionary, num_of_node_pairs):
    ...
    for i in tqdm(range(num_of_node_pairs)):
        node_pair_feature_matrices[i] = convert_node_pair_into_picture_data(node_combination_list[i], feature_matrix,
                                                                            dictionary)
        DenseNetGui.update_progress_bar(num_of_node_pairs * 2, 0)
    print(
...
def create_data_set_to_file(graph, node2vec_feature_vector_file_name, node_combination_list, data_set_file_name,
    ...
    all_node_pairs_feature_matrix = convert_all_node_pairs_into_picture_data(node_pair_feature_matrix,
                                                                             node_combination_list, dictionary,
                                                                             num_of_node_pairs)
